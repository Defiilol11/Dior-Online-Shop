        ...
        @else
            <div class="cart-container">
                ...
                <div class="cart-summary">
                    <h3>Total: Q{{ number_format($cartItems->sum(function($item) { return $item->product->price * $item->quantity; }), 2) }}</h3>
                    <button onclick="window.location.href='{{ route('checkout.show') }}'" class="checkout-btn">COMPRA</button>
                </div>
            </div>
        @endif
    </div>
